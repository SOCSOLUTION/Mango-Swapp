...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://freeswapp - check the URL carefully.", { domain: DOMAIN })
  ...
  return (
    <Container className="warning-banner">
      ...
      <AtomBox display={{ xs: 'none', lg: 'flex' }} alignItems="center" justifyContent="center" width="full">
        <InnerContainer>
          <img src="https://www.pinclipart.com/picdir/big/332-3320373_mango-png-hd-photo-mango-cartoon-clipart.png" alt="phishing-warning" width="78px" />
