...
const Container = styled(Flex)`
  ...
  padding: 12px;
  align-items: center;
  background: linear-gradient(rgb(252,176,22) 0%,rgb(0,100,0) 100%),
  linear-gradient(rgb(252,176,22) 0%,rgb(0,100,0) 100%);
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting  https://freeswapp - check the URL carefully.", { domain })
        ...
        <>
          <InnerContainer>
            <img
              ...
              width="92px"
              onError={(e) => {
                const fallbackSrc = 'https://www.pinclipart.com/picdir/big/332-3320373_mango-png-hd-photo-mango-cartoon-clipart.png'
