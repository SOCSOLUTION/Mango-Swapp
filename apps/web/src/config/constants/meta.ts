...
export const DEFAULT_META: PageMeta = {
  title: 'mangoswapp',
  description:
    'The most popular AMM on BSC by user count! Initial Farm Offerings (new token launch model pioneered by mangoswapp), NFTs, and more, on a platform you can trust.',
  image: 'https://pbs.twimg.com/media/FmHgC9OaYAE55GS?format=png&name=small',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('mangoswapp'),
  }
}
